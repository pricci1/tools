...
| Name | Purpose |
|------|---------|
| [Atuin History Mover](./atuin-history-mover) | Move or copy shell history between directories |
| [ESP32 Repeater Config](./esp32-repeater-config) | Web Bluetooth interface for configuring WiFi credentials on an ESP32 repeater |
